  ...
  return (
    <section className="min-h-screen py-16 px-8 bg-black text-white">
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-6xl font-extrabold text-yellow-400 mb-8">About TaxGen</h1>
        <p className="text-gray-300 text-lg leading-relaxed max-w-3xl mx-auto">
          TaxGen is an AI-powered tax assistant that simplifies tax filing, optimizes savings, and ensures compliance 
